        ...
        ScrollView {
            ...
            VStack(spacing: 8) {
                ...
                VStack(spacing: 8) {
                    ...
                    HotelBasicInfoView(hotelAdress: bookingViewModel.bookingInfo?.hotelAdress, hotelRating: bookingViewModel.bookingInfo?.horating, hotelRatingName: bookingViewModel.bookingInfo?.ratingName)
                        .padding(16)
            ...
            VStack(spacing: 8) {
                ...
                ZStack(alignment: .leading) {
                    ...
                    FloatingLabelTextField(placeholder: "Номер телефона", text: $bookingViewModel.number, keyboardtype: .phonePad)
                        ...
                        .onChange(of: bookingViewModel.number) {
                            if !bookingViewModel.number.isEmpty {
                                ...
                                phoneMask.combineAndReplace(string1: bookingViewModel.number)
                            }
                        }
                    ...
                    Text(phoneMask)
                        ...
                        .opacity(phoneFieldIsFocused ? 1.0 : 0.0)
